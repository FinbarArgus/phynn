...
class TimeIntegrator(nn.Module):
    ...
    def sv_step_wgrads(self, x, q_0, p_0, dq_dx_0, dp_dx_0, dt):
        ...
        :return:
        """
        q_dot_0, p_dot_0, dq_dot_dx_0, dp_dot_dx_0, H_0 = self.model.forward_wgrads(x, q_0, p_0)
        x = x.detach()
        q_0 = q_0.detach()
        p_0 = p_0.detach()
        ...
        q_dot_temp, p_dot_temp, dq_dot_dx_temp, dp_dot_dx_temp, _ = self.model.forward_wgrads(x, q_0, p_temp)
        x = x.detach()
        q_0 = q_0.detach()
        p_temp = p_temp.detach()
        dq_dx_0 = dq_dx_0.detach()
        ...
        q_dot_temp2, p_dot_temp2, dq_dot_dx_temp2, dp_dot_dx_temp2, _ = self.model.forward_wgrads(x, q_1, p_temp)
        # x = x.detach()
        q_1 = q_1.detach()
        p_temp = p_temp.detach()
